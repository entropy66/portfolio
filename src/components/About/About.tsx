...
export function About() {
  ...
  return (
    <section className={styles.about} id="about">
      <div className={styles.sectionTag}>{t.about.label}</div>
      ...
      <div className={styles.grid} ref={ref}>
        ...
        >
          {personal.avatar ? (
            ...
            <div className={styles.avatarPlaceholder}>{personal.name.charAt(0)}</div>
          )}
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoItem}>
              ...
              <span className={styles.infoValue}><a href={`mailto:${personal.email}`}>{personal.email}</a></span>
            </div>
            {personal.phone && (
              <div className={styles.infoItem}>
            ...
            <div className={styles.infoItem}>
              ...
              <span className={styles.infoValue}>
                {personal.social.map((s: any, i: number) => (
                  <span key={s.platform}>
