const zhCN = {
  ...
  skillsData: [
    ...
    { name: '工程量计算', category: 'engineering' as const },
    { name: 'RIF / ITAP 验收流程', category: 'engineering' as const },
    { name: 'Rebar / Soil / SRT / Prode 检测', category: 'engineering' as const },
    { name: 'Code of Practice', category: 'engineering' as const },
    { name: 'Buildings Ordinance', category: 'engineering' as const },
    { name: '网站搭建与运营', category: 'tech' as const },
    { name: '量化交易策略', category: 'tech' as const },
    { name: '数据分析', category: 'tech' as const },
    { name: 'AI 工具应用', category: 'tech' as const },
    { name: '信息处理系统开发', category: 'tech' as const },
    { name: 'Microsoft Office', category: 'general' as const },
    { name: '英文读写', category: 'general' as const },
  ],
