const zhCN = {
  ...
  personal: {
    ...
    bio: '广东工业大学土木工程学士。在香港 Chevalier 建筑公司担任助理工程师 2 年——协调政府基建项目招标、施工、行政三个阶段，确保按时交付。2025 年开始科技创业，搭建 AI Token 平台，500+ 用户，200 亿+ Token 消耗，盈利。经历过量化交易亏损，深刻认识到"技术只是工具，风控才是核心"。正在寻找将工程思维与技术能力结合的新机会。',
  ...
  experienceData: [
    ...
    },
    {
      ...
      highlights: [
        '搭建 AI Token 交易平台：500+ 用户，200 亿+ Token 消耗，盈利',
