  ...
  experienceData: [
    {
      ...
      description: '轮岗招标、现场、行政三个部门，覆盖政府项目从投标到验收全流程。',
      highlights: [
              '完成 6 个政府基建项目投标（SSM 520、SSN 505 等），负责 BQ 编制与招标文件管理',
              '驻场 SSM518 公屋项目 9 个月，独立协调施工进度、解决技术问题',
              '对接政府部门与客户完成验收，确保项目按期交付',
              '整理公司 10 年人事与财务档案，建立可检索的文件管理体系',
              '协调合作公司纠纷，有效维护公司利益',
            ],
      technologies: ['招标文件管理', '工程量数据整理', '现场协调', '质量验收', '档案管理'],
    },
    {
      id: 'exp-2',
      company: '独立创业',
