const zhTW = {
  ...
  skillsData: [
      // ── 工程管理 ──
      { name: '招標文件審核與工程量數據整理', category: 'engineering' as const },
      { name: '現場協調與質量驗收管理', category: 'engineering' as const },
      { name: '檔案整理與信息管理', category: 'engineering' as const },
      { name: '四方 Stakeholder 協調', category: 'engineering' as const },
      ...
      { name: '交易系統中建立系統化風控框架', category: 'strengths' as const },
    ],
  ...
  experienceData: [
    {
      ...
      description: '輪崗招標、現場、行政三個部門，覆蓋政府項目從投標到驗收全流程。',
      highlights: [
        '完成 6 個政府基建項目投標（SSM 520、SSN 505 等），負責 BQ 編製與招標文件管理',
        '駐場 SSM518 公屋項目 9 個月，獨立協調施工進度、解決技術問題',
        '對接政府部門與客戶完成驗收，確保項目按期交付',
        '整理公司 10 年人事與財務檔案，建立可檢索的文件管理體系',
        '協調合作公司糾紛，有效維護公司利益',
      ],
      technologies: ['招標文件管理', '工程量數據整理', '現場協調', '質量驗收', '檔案管理'],
    },
    {
      id: 'exp-2',
      company: '獨立創業',
