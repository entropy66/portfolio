  ...
  experienceData: [
    {
      ...
      description: 'Rotated through tender, site, and admin departments — covering government projects from bid to handover.',
      highlights: [
              'Completed 6 government infrastructure tenders (SSM 520, SSN 505, etc.), handled BQ preparation and tender document management',
              'On-site at SSM518 public housing for 9 months, independently managed construction progress and resolved technical issues',
              'Liaised with government and client departments for inspection, ensured on-time project delivery',
              'Organized 10 years of HR and finance archives into a searchable document system',
              'Resolved partner company disputes, protected company interests',
            ],
      technologies: ['Tender Document Management', 'Quantity Data Analysis', 'Site Coordination', 'Quality Acceptance', 'Records Management'],
    },
    {
      id: 'exp-2',
